        ...
        <nav class="navbar navbar-expand-lg bg-light navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav m-auto py-0">
                    ...
                    <a href="my_orders.php" class="nav-item nav-link">orders</a>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-5 pb-4 pb-lg-0">
                    <img class="img-fluid w-100" src="img/header.jpg" alt="">
                ...
                <div class="col-lg-5">
                    <div class="bg-primary py-5 px-4 px-sm-5">
                        <form class="py-5">
                            ...
                            <div>
                                <button class="btn btn-dark btn-block border-0 py-3" type="submit"><a href="register.php">register</a></button>
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-5">
                    <div class="bg-secondary">
                        ...
                        <div class="d-flex flex-column align-items-center py-4">
                           ...
                           <a href="place_order.php" class="btn btn-primary py-2 px-4 my-2">Order Now</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
